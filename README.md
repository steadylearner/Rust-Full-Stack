...
Test projects here or read [the Rust blog posts at Steadylearner][Steadylearner Rust Blog Posts]. You can also make an issue.

[If you need a developer to work with you, please contact me](https://www.linkedin.com/in/steady-learner-3151b7164/).
...
These are from others. Visit them also.
...
1. Play with Tkinter and Selenium a little bit more.
2. Use private repository for production files instead and make a version control correctly.
3. GUI app for post reader, Freelance Job List manager, Tranlsator, Web scrapers caller, Transaction etc with Python.
3. Make your own crate or contribute to a specific one.
...
This is to record and encourage helping other people with commits.
