...
fn main() -> std::io::Result<()> {
    ...
    let mut output = Vec::<u8>::new();;
    {
        ...
        // // println!("{:?}", &vec_of_split_payload);

        // let (y, m, d) = (
        //     vec_of_split_payload[0],
        //     vec_of_split_payload[1],
        //     vec_of_split_payload[2],
        // );
        ...
        //     m.parse::<u32>().expect("Invalid Number"),
        //     d.parse::<u32>().expect("Invalid Number"),
        // );

        // let date = DateTime::from_utc(
        //     NaiveDate::from_ymd(year, month, day).and_hms(9, 10, 11),
        //     FixedOffset::east(0),
        // );
