...
// Use https://github.com/mjkillough/factori if you want default values with macro.

// Refer to the official documentation 
// if you want to use impl Default instead with struct
// https://doc.rust-lang.org/std/default/trait.Default.html
// and files in https://github.com/greyblake/ta-rs/tree/master/src/indicators
// $grep -R "impl Default"

// We use functions for default values instead. 
mod utils;
use utils::{
    str_from_stdin,
